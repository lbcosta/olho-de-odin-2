...
## Histórico Detalhado em Gráficos (Histórico)
- **URL**: `POST /pt/intro/shop-search/market-price`
- **Payload Base**: `[{"type":"price","params":{"itemId":<id>,"svrId":<id>,"page":1,"limit":10,"period":"$undefined"}}]`
- **O que extrair**: Dados diários que geram os gráficos de oscilação do mercado (`priceDetailDayList`).
